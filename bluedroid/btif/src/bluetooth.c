...
rtkbt_autopair_callbacks_t *rtkbt_autopair_hal_cbacks = NULL;
#endif
...
#ifdef BLUETOOTH_RTK_AUTOPAIR
static int rtkbt_autopair_init(rtkbt_autopair_callbacks_t* rtkbt_autopair_cbacks)
{
        ALOGI("<== RTKAutoPair ==> rtkbt_autopair_init");
            if (interface_ready() == FALSE)
                        return BT_STATUS_FAIL;

                rtkbt_autopair_hal_cbacks = rtkbt_autopair_cbacks;
