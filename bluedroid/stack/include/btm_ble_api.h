...
#define BTM_BLE_SCAN_SLOW_INT_1    104    /* 1.28 s   = 2048 *0.625 */
#endif
#ifndef BTM_BLE_SCAN_SLOW_WIN_1
#define BTM_BLE_SCAN_SLOW_WIN_1   8      /* 11.25 ms = 18 *0.625 */
#endif
...
#ifdef BLUETOOTH_RTK
#define BTM_BLE_CONN_INT_MIN_DEF     0x06      /* recommended min: 30ms  = 24 * 1.25 */
#else
