...
#define L2C_BLE_CONN_UPDATE_DISABLE   0x1
#define L2C_BLE_NEW_CONN_PARAM        0x2
#define L2C_BLE_UPDATE_PENDING        0x4
#define L2C_BLE_NOT_DEFAULE_PARAM        0x8
